...
class PersonalDetails():
    ...
    def get_content(self) -> toga.Box:
        ...
        header_label = toga.Label("Age, Height, Weight and BMI: ", style=Pack(font_size=20, padding=(10, 5)))
        age_label = toga.Label("Age: ", style=Pack(color = 'black', font_size=15, padding=(0, 15)))
        height_label = toga.Label("Height: ", style=Pack(color = 'black', font_size=15, padding=(0, 15)))
        weight_label = toga.Label("Weight: ", style=Pack(color = 'black', font_size=15, padding=(0, 15)))
        bmi_label = toga.Label("BMI: ", style=Pack(color = 'black', font_size=15, padding=(0, 15)))

        # text input + button for physical analysis
        self.age_input = toga.TextInput(placeholder='Enter your age', style=Pack(color = 'black', background_color="#fbf5cc"), value=self.app.user.age)
        age_input_box = create_border(self.age_input, inner_color="#fbf5cc", padding=(2, 13, 0))

        self.height_input = toga.TextInput(placeholder='cm', style=Pack(color = 'black', background_color="#fbf5cc"), value=self.app.user.height)
        height_input_box = create_border(self.height_input, inner_color="#fbf5cc", padding=(2, 13, 0))

        self.weight_input = toga.TextInput(placeholder='kg', style=Pack(color = 'black', background_color="#fbf5cc"), value=self.app.user.weight)
