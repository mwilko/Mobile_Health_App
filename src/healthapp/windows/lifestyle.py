...
class Lifestyle():
    ...
    def get_content(self) -> toga.Box:
        ...
        e60_button = toga.Button('Less than 60 mins', on_press=self.lifestyle_handler, style=Pack(background_color="#fbf5cc", padding=(-3)))
        e60_box = create_border(e60_button, inner_color="#fbf5cc")

        e60_119_button = toga.Button('60 - 119 mins', on_press=self.lifestyle_handler, style=Pack(background_color="#fbf5cc", padding=(-3)))
        e60_119_box = create_border(e60_119_button, inner_color="#fbf5cc")

        e120_180_button = toga.Button('120 - 180 mins', on_press=self.lifestyle_handler, style=Pack(background_color="#fbf5cc", padding=(-3)))
        e120_180_box = create_border(e120_180_button, inner_color="#fbf5cc")

        e180_plus_button = toga.Button('More than 180 mins', on_press=self.lifestyle_handler, style=Pack(background_color="#fbf5cc", padding=(-3)))
