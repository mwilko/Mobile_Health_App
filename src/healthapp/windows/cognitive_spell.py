...
class CognitiveSpell():
    def __init__(self, app: HealthApp):  
        ...
        choice1_button = toga.Button('Newmonia', on_press=self.choice1_handler, style=Pack(background_color="#fbf5cc", padding=(-3)))
        choice1_box = create_border(choice1_button, inner_color="#fbf5cc")

        choice2_button = toga.Button('Pneumonia', on_press=self.choice2_handler, style=Pack(background_color="#fbf5cc", padding=(-3)))
        choice2_box = create_border(choice2_button, inner_color="#fbf5cc")

        choice3_button = toga.Button('Pnumonia', on_press=self.choice3_handler, style=Pack(background_color="#fbf5cc", padding=(-3)))
